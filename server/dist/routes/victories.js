...
router.post("/", verifyToken, async (req, res) => {
    try {
        ...
        const result = await pool.query("INSERT INTO victories (user_id, title, description, category, created_at) VALUES ($1, $2, $3, $4, NOW()) RETURNING *", [user_id, title, description, category || "general"]);
